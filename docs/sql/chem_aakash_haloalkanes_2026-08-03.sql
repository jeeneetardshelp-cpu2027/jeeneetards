...
--
-- Source     : https://www.youtube.com/playlist?list=PL7AAT-ai0VD5T7J6u_pQp_h5ckp9spDEf
-- Lessons    : 6 (playlist declares 6)
-- Chapters   : 90 Organic Compounds Containing Halogens
...
begin
  ...
  if exists (select 1 from public.playlists where title = 'Haloalkanes and Haloarenes') then
    raise exception 'course "%" already exists - this file has already been run', 'Haloalkanes and Haloarenes';
  end if;

  if exists (
    select 1 from public.videos
    where youtube_video_id = any(array[
      'ssYfjEa3FX8', 'kwkiEKAmLNw', 'rd2YsjGeMhM', 'o8_e2D4jeCw', 'rjUpBDmHUyQ', 'k2nIugJTJVg'
    ])
  ) then
  ...
  insert into public.playlists (
    ...
    'Haloalkanes and Haloarenes',
    'Haloalkanes and haloarenes taught in sequence, from the official Aakash NEET channel.',
  ...
  for v_row in
    select * from (values
      (1, 'ssYfjEa3FX8', 'Classification, Preparation (Part 1)', 'Classification, Preparation | Haloalkanes, Haloarenes Part 1 | 2025 | JEE, NEET | Ashish Shekhar', 3593, 90),
      (2, 'kwkiEKAmLNw', 'Preparation (continued) (Part 2)', 'Preparation (continued) | Haloalkanes, Haloarenes Part 2 | 2025 | JEE, NEET | Ashish Shekhar', 3641, 90),
      (3, 'rd2YsjGeMhM', 'Physical Properties, SN2 (Part 3)', 'Physical Properties, SN2 | Haloalkanes, Haloarenes Part 3 | 2025 | JEE, NEET | Ashish Shekhar', 3771, 90),
      (4, 'o8_e2D4jeCw', 'SN1, E2 Reactions (Part 4)', 'SN1, E2 Reactions | Haloalkanes, Haloarenes Part 4 | 2025 | JEE, NEET | Ashish Shekhar', 3753, 90),
      (5, 'rjUpBDmHUyQ', 'E1, Elimination/Substitution (Part 5)', 'E1, Elimination/Substitution | Haloalkanes, Haloarenes Part 5 | 2025 | JEE, NEET | Ashish Shekhar', 3631, 90),
      (6, 'k2nIugJTJVg', 'Haloarene Reactions, Polyhalogens (Part 6)', 'Haloarene Reactions, Polyhalogens  | Haloalkanes, Haloarenes Part 6 | 2025 | JEE, NEET | Ashish', 3621, 90)
  ...
  if v_inserted <> 6 then
    raise exception 'expected 6 lessons for "%", inserted %', 'Haloalkanes and Haloarenes', v_inserted;
  end if;
  ...
  if exists (
    ...
    raise exception 'a lesson in "%" was left without a goal or class level', 'Haloalkanes and Haloarenes';
  end if;
end $$;
