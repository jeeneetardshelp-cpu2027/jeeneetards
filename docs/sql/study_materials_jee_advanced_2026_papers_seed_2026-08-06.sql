-- Official JEE (Advanced) 2026 question papers in English and Hindi.
...
begin
  ...
  if jee_id is null then
    raise exception 'JEE ADVANCED 2026 PAPERS PREFLIGHT: JEE learning goal is missing';
  end if;

  for resource in
    select * from (values
      ('JEE Advanced 2026 Paper 1 (English)',
       'Official JEE (Advanced) 2026 Paper 1 question paper in English, covering Mathematics, Physics and Chemistry.',
       'https://jeeadv.ac.in/documents/p1_english.pdf', 'English', 34),
      ('JEE Advanced 2026 Paper 1 (Hindi)',
       'Official JEE (Advanced) 2026 Paper 1 question paper in Hindi, covering Mathematics, Physics and Chemistry.',
       'https://jeeadv.ac.in/documents/p1_hindi.pdf', 'Hindi', 38),
      ('JEE Advanced 2026 Paper 2 (English)',
       'Official JEE (Advanced) 2026 Paper 2 question paper in English, covering Mathematics, Physics and Chemistry.',
       'https://jeeadv.ac.in/documents/p2_english.pdf', 'English', 29),
      ('JEE Advanced 2026 Paper 2 (Hindi)',
       'Official JEE (Advanced) 2026 Paper 2 question paper in Hindi, covering Mathematics, Physics and Chemistry.',
       'https://jeeadv.ac.in/documents/p2_hindi.pdf', 'Hindi', 32)
  ...
  select count(*)::integer into batch_material_count
   ...
   where source_url ~ '^https://jeeadv[.]ac[.]in/documents/p[12]_(english|hindi)[.]pdf$'
     and exam_year = 2026;
  if batch_material_count <> 4 then
    raise exception 'JEE ADVANCED 2026 PAPERS POSTFLIGHT: expected 4 materials, found %', batch_material_count;
  end if;
  ...
  select count(*)::integer into batch_scope_count
   ...
   where m.source_url ~ '^https://jeeadv[.]ac[.]in/documents/p[12]_(english|hindi)[.]pdf$'
     and m.exam_year = 2026
  ...
  if batch_scope_count <> 4 then
    raise exception 'JEE ADVANCED 2026 PAPERS POSTFLIGHT: expected 4 JEE-only scopes, found %', batch_scope_count;
  end if;
end $$;
