...
const expected = new Map([
  ["2025_1_English.pdf", 31],
  ["2025_1_Hindi.pdf", 36],
  ["2025_2_English.pdf", 21],
  ["2025_2_Hindi.pdf", 24],
]);

describe("JEE Advanced 2025 question-paper seed", () => {
  it("contains all four visually verified official PDFs and page counts", () => {
    ...
    expect(seed.match(/https:\/\/jeeadv\.ac\.in\/past_qps\/2025_[12]_(?:English|Hindi)\.pdf/g))
      .toHaveLength(4);
    expect(seed).toContain("'previous_year_paper'");
    expect(seed).toContain("'official_source'");
    expect(seed).toContain("2025");
  });
