...
const expected = new Map([
  ["2021_1_English.pdf", 29],
  ["2021_1_Hindi.pdf", 33],
  ["2021_2_English.pdf", 29],
  ["2021_2_Hindi.pdf", 34],
]);

describe("JEE Advanced 2021 question-paper seed", () => {
  it("contains all four visually verified official PDFs and page counts", () => {
    ...
    expect(seed.match(/https:\/\/jeeadv\.ac\.in\/past_qps\/2021_[12]_(?:English|Hindi)\.pdf/g))
      .toHaveLength(4);
    expect(seed).toContain("'previous_year_paper'");
    expect(seed).toContain("'official_source'");
    expect(seed).toContain("2021");
  });
