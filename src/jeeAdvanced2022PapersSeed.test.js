...
const expected = new Map([
  ["2022_1_English.pdf", 31],
  ["2022_1_Hindi.pdf", 31],
  ["2022_2_English.pdf", 26],
  ["2022_2_Hindi.pdf", 29],
]);

describe("JEE Advanced 2022 question-paper seed", () => {
  it("contains all four visually verified official PDFs and page counts", () => {
    ...
    expect(seed.match(/https:\/\/jeeadv\.ac\.in\/past_qps\/2022_[12]_(?:English|Hindi)\.pdf/g))
      .toHaveLength(4);
    expect(seed).toContain("'previous_year_paper'");
    expect(seed).toContain("'official_source'");
    expect(seed).toContain("2022");
  });
