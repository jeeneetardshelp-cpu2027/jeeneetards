...
const expected = new Map([
  ["2020_1_English.pdf", 24],
  ["2020_1_Hindi.pdf", 27],
  ["2020_2_English.pdf", 22],
  ["2020_2_Hindi.pdf", 24],
]);

describe("JEE Advanced 2020 question-paper seed", () => {
  it("contains all four visually verified official PDFs and page counts", () => {
    ...
    expect(seed.match(/https:\/\/jeeadv\.ac\.in\/past_qps\/2020_[12]_(?:English|Hindi)\.pdf/g))
      .toHaveLength(4);
    expect(seed).toContain("'previous_year_paper'");
    expect(seed).toContain("'official_source'");
    expect(seed).toContain("2020");
  });
