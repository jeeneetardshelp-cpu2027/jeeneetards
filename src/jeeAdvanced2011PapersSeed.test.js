...
describe("IIT-JEE 2011 question-paper seed", () => {
  it("contains both visually verified official English PDFs and page counts", () => {
    ...
    expect(seed.match(/https:\/\/jeeadv\.ac\.in\/past_qps\/2011_[12]\.pdf/g)).toHaveLength(2);
    ...
    expect(seed).toContain("IIT-JEE 2011");
