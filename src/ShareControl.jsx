// ShareControl.jsx — one-tap share for a page worth sending.
//
// Grown out of polls/ShareControl.jsx so the course watch page and the polls
// can offer the same three paths without two implementations. In order of what
...
export default function ShareControl({
  ...
  className = "",
  size = "md",
  // Names what the buttons send in their assistive labels — "this poll",
  // "this course" — so a screen reader hears which link it is.
  subject = "this page",
}) {
  ...
  return (
    <div className={`flex flex-wrap items-center gap-2 ${className}`}>
      ...
      <a
        ...
        className={base}
        aria-label={`Share ${subject} on WhatsApp`}
      >
      ...
      <button
        ...
        onClick={copyLink}
        className={base}
        aria-label={`Copy a link to ${subject}`}
      >
